...
const serviceName = "nyosor"; // Ganti dengan nama workers kalian
const apiKey = "36d1b9e7213b8c601d7f0b17916b1740afb50"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "andestpao82@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "0060fb95a480028321dd8eaac593a901"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "6d47029972b355697aef5de8c6bfa130"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
