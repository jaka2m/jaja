...
// Variables
const rootDomain = "wanita.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "git"; // Ganti dengan nama workers kalian
...
const KV_PROXY_URL = "https://raw.githubusercontent.com/Nizwara/dark/refs/heads/main/kvProxyList.json";
const PROXY_BANK_URL = "https://raw.githubusercontent.com/Nizwara/dark/refs/heads/main/proxyList.txt";
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>Dark-System</span>");
