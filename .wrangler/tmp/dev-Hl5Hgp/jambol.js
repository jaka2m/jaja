	...
	<div class="card w-full max-w-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div>
                    ...
                    <select id="format" class="form-select p-3 rounded-lg w-full input-dark">
...
var UNIFIED_CSS = `
    ...
    :root {
      ...
      --primary-dark: #3b73b5;
      --primary-light: #8cb9ed;
      --secondary: #06b6d4; /* Cyan */
      --accent: #a466e8; /* Accent Purple */
      --danger: #ef4444;
      --warning: #f59e0b;
      ...
      --glass: rgba(30, 41, 59, 0.4); /* Slate 800 with alpha */
      --glass-border: rgba(102, 181, 232, 0.4); /* accent-blue with alpha */
      --glass-hover: rgba(45, 55, 72, 0.5);
    }
    ...
    * {
    ...
    .main-container, .card {
        ...
        box-shadow: 0 40px 80px rgba(0, 0, 0, 0.8), 0 0 30px var(--glass-border) inset;
        padding: 2rem;
        margin-bottom: 2rem;
    ...
    .main-container:hover, .card:hover {
        ...
        box-shadow: 0 60px 100px rgba(0, 0, 0, 0.9), 0 0 40px rgba(102, 181, 232, 0.6) inset;
    }
    ...
    .btn-gradient:hover:not(:disabled) {
        box-shadow: 0 2px 8px rgba(0, 0, 0, 0.8), inset 0 1px 4px rgba(0, 0, 0, 0.8), 0 0 15px var(--primary);
    ...
    /* 5. FORMS & INPUTS */
    .input-dark, .form-input, .form-select {
    ...
    .input-dark:focus, .form-input:focus, .form-select:focus {
        border-color: var(--primary);
        box-shadow: inset 0 2px 4px rgba(0, 0, 0, 0.6), 0 0 10px var(--primary);
...
<div class="card slide-up">
                ...
                <br>
                <div id="proxy-list-container" class="w-full max-w-7xl mx-auto">
    ...
    for (let i = 0; i < this.proxies.length; i++) {
      ...
      cards += `
                <div class="card flex flex-col p-4 rounded-2xl transform hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <div class="flex-grow space-y-2 text-sm text-gray-300 mb-4">
                        <p><strong class="font-semibold text-gray-100">IP:</strong> <span class="font-mono">${prx.prxIP}</span></p>
                        <p><strong class="font-semibold text-gray-100">Port:</strong> <span class="font-mono">${prx.prxPort}</span></p>
                        <p><strong class="font-semibold text-gray-100">ISP:</strong> <span>${prx.org}</span></p>
                    </div>
                    <div class="mt-auto">
                         <p id="ping-${i}" class="text-center text-sm mb-3 h-10 flex items-center justify-center">${prx.prxIP}:${prx.prxPort}</p>
                         <button onclick="copyToClipboard(\`${proxyConfigs}\`)" class="w-full text-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors duration-200 btn-gradient">
                            Copy Config
                         </button>
                    </div>
                </div>
